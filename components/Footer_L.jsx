...
<h3 className='font-[texgyreadventor] font-bold text-[18.75px] mr-10 md:mr-0   mt-4'>CONNECT WITH US</h3>
...
<h3 className='font-[texgyreadventor] font-bold text-[18.75px] ml-2 mt-4 uppercase '>Subscribe  with Us</h3>
<div className='flex items-center mr-8 pt-5 lg:pt-3'>
<input placeholder='ENTER YOUR EMAIL' className='p-2 md:px-4 xl:px-10 w-full text-black
 text-md  rounded-l-md placeholder-black/60 '/>
<button className='p-[6px] bg-[#2C97EA] md:rounded-e-md'><TiMail size={30}/></button>
        ...
        <div className='pt-10 ml-3 md:pt-0 md:ml-0  '> 
            <h3 className=' font-[texgyreadventor] font-bold text-[18.75px] ml-2 mt-4'>@ INSTAGRAM</h3>
